...
$pageS=5;
 ...
 //$_p==0
		...
		if($_p==1){ include "./php/policy1.php"; }
		
			
		if($_p==2){ include "./php/policy2.php"; } //$_p==1
			
			$data[certi]='';  //증권번호
			$data[school1]='';$data[juso]='';$data[today]='';$data[ysigi]='';$data[school2]='';$data[school5]='';
			$data[week_total]='';$data[dambo2]='';$data[dambo3]='';$data[dambo5]='';$data[dambo6]='';$data[dambo7]='';
			$data[dambo8]='';$data[dambo9]='';$data[dambo10]='';$data[preiminum]='';
			$data[policy]='';
		if($_p==3){ include "./php/policy3.php"; } //$_p==2
		
		if($_p==4){ include "./php/policy4.php"; } //$_p==3
  }
   $pdf->Output();  
?> 