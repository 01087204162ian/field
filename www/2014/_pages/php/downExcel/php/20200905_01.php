...
/* $data[school2]=iconv("utf-8","euc-kr",$row[school1]); //피보험자

/$data[gabunho]=$row[gabunho];	//가계약 번호 

$gigan=$row[school7]." ~  ".$row[school8];
$data[sigi]=iconv("utf-8","euc-kr",$gigan);	//보험기간

$data[preiminum]=number_format($Preminum);
   

$data[school3]=iconv("utf-8","euc-kr",$row[school1]); //피보험자
