...
<body>
    ...
    <div class="top-bar">
		...
		<div class="menu">
			...
			<a href="#" class="menu-item" data-section="여행자배상책임">여행자보험</a>
		</div>
    ...
    <div class="content">
        ...
        <div class="main-content">
		      ...
		      <div class="search-section">
				<!-- 좌측 끝 버튼 -->
				<button class="btn btn-left">좌측 버튼 1</button>
				<button class="btn btn-left">좌측 버튼 2</button>
				<button class="btn btn-left">좌측 버튼 3</button>
				
				<!-- 학교명 검색 -->
				<input type="text" id="search-school" placeholder="학교명 입력">
				<button id="search-btn" class="btn btn-primary">검색</button>
				
				<!-- 우측 끝 버튼 -->
				<button class="btn btn-right">우측 버튼 1</button>
				<button class="btn btn-right">우측 버튼 2</button>
				<button class="btn btn-right">우측 버튼 3</button>
			</div>
